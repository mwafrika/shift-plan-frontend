...
export const EXPORT_SHIFTS_START = "EXPORT_SHIFTS_START";
export const EXPORT_SHIFTS_SUCCESS = "EXPORT_SHIFTS_SUCCESS";
export const EXPORT_SHIFTS_FAILURE = "EXPORT_SHIFTS_FAILURE";
