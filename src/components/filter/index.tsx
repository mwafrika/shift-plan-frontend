  ...
  return (
    <div className="flex flex-col gap-4">
        <div className=" bg-white rounded-lg flex flex-row items-center gap-2 w-[30%]">
            <div className="flex flex-row items-center gap-2 text-primary/30 px-2 ">
            <FaFilter size={10}/>
            <p>All</p>
            </div>
        ...
        <div className="flex flex-row items-center gap-4">
          <p className="text-[12px] text-primary font-semibold">
            {filter.label1}
            <span className="text-black text-[10px] py-1 px-2 bg-primary/20 rounded-[50%] ml-2">{filter.total}</span>
          </p>
